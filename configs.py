...
STREAM_LOGS = environ.get('STREAM_LOGS','-1001884214513')
...
class Config(object):
	...
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "airfilesrobot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002289748546))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6221765779"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://Akggautam:Akgs@cluster0.8msp2ne.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002183733738")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002183733738")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://graph.org/file/44cb9cd9617551b729189-dd13a291c46458d6a3.jpg")
